...
namespace PPS.Solver.Tests
{
    ...
    public class PrimitivePolylineTests
    {
        ...
        {
            var points = PrimitiveShape.Line.LocalPoints(2.5f);
        ...
        {
            var points = PrimitiveShape.Triangle.LocalPoints(3f);
        ...
        public void 삼각형의_끝_점은_첫_점과_정확히_같다()
        {
            ...
            var points = PrimitiveShape.Triangle.LocalPoints(1.7f);
        ...
        {
            var points = PrimitiveShape.Triangle.LocalPoints(2f);
        ...
        {
            var points = PrimitiveShape.Line.LocalPoints(1f);
        ...
        public void Center와_Angle은_적용하지_않는다()
        {
            ...
            var points = PrimitiveShape.Triangle.LocalPoints(4f);
